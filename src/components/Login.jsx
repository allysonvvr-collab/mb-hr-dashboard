      ...
      <div style={{
        ...
        {mode === 'login' ? (
          <form onSubmit={handleLogin}>
            ...
            <button type="submit" disabled={busy} style={{ width:'100%', padding:'12px', background: busy ? '#4d9973' : '#1B3A2D', color:'#fff', border:'none', borderRadius:9, fontSize:15, fontWeight:700, cursor: busy ? 'not-allowed' : 'pointer', fontFamily:'inherit' }}>
